...
//    public static final BigDecimal CREW_TELLER_CATEGORY = new BigDecimal(4);
    ...
    public static final String POS_USER_DISABLED = "018";


    // POS USER ROLES
    public static final String USER_ROLE_BANK_ADMIN = "ADMIN";
    public static final String USER_ROLE_BANK_ADMINISTRATOR = "ADMINISTRATOR";
    public static final String USER_ROLE_SUPERVISOR = "SUPERVISOR";
    public static final String USER_ROLE_BANK_FIELD_SUPERVISOR = "FIELD SUPERVISOR";
    public static final String USER_ROLE_MERCHANT = "MERCHANT";
    public static final String USER_ROLE_CASHIER = "CASHIER";
    public static final String USER_ROLE_TELLER = "TELLER";
