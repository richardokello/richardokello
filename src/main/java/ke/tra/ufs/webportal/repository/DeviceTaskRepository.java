...
import ke.tra.ufs.webportal.entities.TmsDeviceTask;
...
public interface DeviceTaskRepository extends CrudRepository<TmsDeviceTask, BigDecimal> {
     ...
     * @return
     */
    @Query("SELECT new ke.tra.ufs.webportal.entities.wrapper.SchedulerWrapper(u.taskId,u.downloadStatus,u.startDownloadTime,"
