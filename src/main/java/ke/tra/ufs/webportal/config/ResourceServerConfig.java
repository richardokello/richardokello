...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/pos-role").hasAuthority("CREATE_POS_ROLES")
                ...
                .antMatchers(HttpMethod.PUT, "/pos-role").hasAuthority("UPDATE_POS_ROLES")
                .antMatchers(HttpMethod.PUT, "/pos-role/approve-actions", "/pos-role/decline-actions").hasAuthority("APPROVE_POS_ROLES")
                .antMatchers(HttpMethod.DELETE, "/pos-role").hasAuthority("DELETE_POS_ROLES")
