 ...
 */
package ke.tracom.ufs.utils.filters;

import ke.axle.chassis.wrappers.ResponseWrapper;
import com.fasterxml.jackson.databind.ObjectMapper;
import ke.tracom.ufs.security.OTPAuthentication;
...
//    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (auth == null || auth instanceof AnonymousAuthenticationToken
                ...
                || fi.getRequestUrl().contains("/oauth/logout") || fi.getRequestUrl().contains("/otp/verification") || fi.getRequestUrl().contains("/change-password/first-time")//change-password/first-time
                || (accessToken != null && accessToken instanceof OtpOAuth2AccessToken)
                || fi.getRequestUrl().contains("/user/me") || fi.getRequestUrl().contains("/otp/resend") || fi.getRequestUrl().contains("/test") || fi.getRequestUrl().contains("/workgroup")) {
