...
public class AppConstants {
    ...
    public static final Short STATUS_DEACTIVATE = 7;
    ...
    public static final String ACTIVITY_STATUS_SUCCESS = "Successful";
    ...
    public static final String BATCH_TYPE_GEOGRAPHICAL = "Geographical Region";

    public static final String SMS_SEND_NOW = "SEND_NOW";
    public static final String EMAIL_SEND_NOW = "SEND_NOW";
    public static final String EMAIL_TYPE_MESSAGE = "PREDEFINED_EMAIL";

    public static final String USER_BACK_OFFICE = "Back Office User";
    public static final String USER_REGIONAL_MANAGER= "Regional Manager";
    ...
    public static final String SUPERVIEWER = "SUPER VIEWER";q
}
