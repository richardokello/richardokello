...
public class UfsGeographicalRegion implements Serializable {
    ...
    private String text;
    @Transient
    private List<UfsGeographicalRegion> children;
    ...
    public UfsGeographicalRegion(String regionName, String actionStatus, BigDecimal parentIds, String tenantIds) {
    }

    public UfsGeographicalRegion(String regionName, String actionStatus, String tenantIds) {
    }
    ...
    public List<UfsGeographicalRegion> getChildren() {
        return this.getUfsGeographicalRegionList();
    }

    public void setChildren(List<UfsGeographicalRegion> children) {
