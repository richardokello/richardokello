...
public class UfsOtpCategory implements Serializable {
    ...
    @Basic(optional = false)
    @GenericGenerator(
            name = "UFS_OTP_CATEGORY_SEQ",
            strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @org.hibernate.annotations.Parameter(name = "sequence_name", value = "UFS_OTP_CATEGORY_SEQ"),
                    @org.hibernate.annotations.Parameter(name = "initial_value", value = "0"),
                    @org.hibernate.annotations.Parameter(name = "increment_size", value = "1")
            }
    )
    @GeneratedValue(generator = "UFS_OTP_CATEGORY_SEQ")
