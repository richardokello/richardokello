...
public class UfsBusinessUnits implements Serializable {
    ...
    @GenericGenerator(
            name = "UFS_BUSINESS_UNITS_SEQ",
            strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @org.hibernate.annotations.Parameter(name = "sequence_name", value = "UFS_BUSINESS_UNITS_SEQ"),
                    @org.hibernate.annotations.Parameter(name = "initial_value", value = "0"),
                    @org.hibernate.annotations.Parameter(name = "increment_size", value = "1")
            }
    )

    @GeneratedValue(generator = "UFS_BUSINESS_UNITS_SEQ")
    @Column(name = "ID")
