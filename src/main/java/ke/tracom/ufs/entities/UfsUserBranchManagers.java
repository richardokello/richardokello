...
public class UfsUserBranchManagers implements Serializable {
    ...
    @GenericGenerator(
            name = "UFS_USER_BRANCH_MANAGERS_SEQ",
            strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @org.hibernate.annotations.Parameter(name = "sequence_name", value = "UFS_USER_BRANCH_MANAGERS_SEQ"),
                    @org.hibernate.annotations.Parameter(name = "initial_value", value = "0"),
                    @org.hibernate.annotations.Parameter(name = "increment_size", value = "1")
            }
    )
    @GeneratedValue(generator = "UFS_USER_BRANCH_MANAGERS_SEQ")
    @Column(name = "ID")
    ...
    public String toString() {
        return "ke.tra.ufs.fieldagent.entities.UfsUserBranchManagers[ id=" + id + " ]";
    }
