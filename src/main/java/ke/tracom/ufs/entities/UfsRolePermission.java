...
public class UfsRolePermission implements Serializable {
    ...
    @Basic(optional = false)
    @GenericGenerator(
            name = "UFS_ROLE_PERMISSION_SEQ",
            strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @org.hibernate.annotations.Parameter(name = "sequence_name", value = "UFS_ROLE_PERMISSION_SEQ"),
                    @org.hibernate.annotations.Parameter(name = "initial_value", value = "0"),
                    @org.hibernate.annotations.Parameter(name = "increment_size", value = "1")
            }
    )
    @GeneratedValue(generator = "UFS_ROLE_PERMISSION_SEQ")
    @Column(name = "ROLE_PERM_ID")
    private Long rolePermId;
    @JoinColumn(name = "PERMISSION", referencedColumnName = "ENTITY_PERMISSION_ID",insertable = false, updatable = false)
    ...
    public UfsRolePermission(Long permissionId, Long roleId, String intrash) {
