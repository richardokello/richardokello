...
public class AgentWrapper {
    ...
    public AgentWrapper(BigDecimal agentId) {
        this.agentId = agentId;
    }

    public AgentWrapper(BigDecimal agentId, String name, String agentCode) {
        this.agentId = agentId;
        this.name = name;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AgentWrapper)) {
            return false;
        }
        AgentWrapper other = (AgentWrapper) object;
    ...
    public String toString() {
        return "com.ufs.tidservice.tidfetch.entities.AgentWrapper[ agentId=" + agentId + " ]";
    }
