...
public enum AppConstants {
  ...
  EXCEPTION_OCCURRED_ON_EXTERNAL_HTTP_REQUEST(
      "05", "An exception occurred while sending request to external party"),
  ...
  AppConstants(String value, String reasonPhrase) {
    this.value = value;
