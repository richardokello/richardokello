...
public class EUCLController {
    ...
    public ResponseEntity<MeterNoValidationResponse> MeterNoValidation(@Valid @RequestBody MeterNoValidation request) {
    ...
    public ResponseEntity<EUCLPaymentResponse> purchaseElectricity(@Valid @RequestBody EUCLPaymentRequest request) {
        String requestRef = RRNGenerator.getInstance("EV").getRRN();
