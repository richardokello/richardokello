 ...
 * @see ISOComponent
 */
public class TracomPackager extends ISOBasePackager {
    ...
    protected ISOFieldPackager fld[] = {
            ...
            /*012*/ new IFB_NUMERIC ( 6, "Time, Local transaction",pad),
            ...
            /*030*/ new IFB_NUMERIC ( 12, "Amounts, original",pad),
            /*031*/ new IFB_NUMERIC ( 9, "Acquirer reference data",pad),
            /*032*/ new IFB_LLCHAR   ( 99, "Acquirer institution ident code"),
            ...
            /*044*/ new IFB_LLCHAR  ( 20, "Additional response data"),
            ...
            /*061*/ new IFB_LLLNUM (12, "Reserved for national use",pad),
    ...
    /**
     * Instantiates a new tracom packager.
     */
    public TracomPackager() {
        super();
