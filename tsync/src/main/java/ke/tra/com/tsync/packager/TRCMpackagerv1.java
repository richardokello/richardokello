 ...
 * @author <a href="mailto:peter.mugenya@tracom.co.ke">Peter Mugenya</a>
 * @author <a href="mailto:apr@cs.com.uy">Alejandro P. Revilla</a>
 * @version $Id: TracomPackage.java 2594 2009-02-09 16:41:31Z apr $
 * @see ISOPackager
 * @see ISOBasePackager
 * @see ISOComponent
 */
public class TRCMpackagerv1 extends ISOBasePackager {
    ...
    protected ISOFieldPackager fld[] = {
            ...
            /*023*/ new IFB_NUMERIC ( 4, "Card sequence number",pad),
            ...
            /*027*/ new IFB_NUMERIC ( 2, "Approval code length",pad),
            ...
            /*032*/ new IFB_LLNUM   ( 99, "Acquirer institution ident code",pad),
            ...
            /*049*/ new IFB_NUMERIC ( 4, "Currency code, Transaction",pad),
            /*050*/ new IFB_NUMERIC ( 4, "Currency code, Reconciliation",pad),
            /*051*/ new IFB_NUMERIC ( 4, "Currency code, Cardholder billing",pad),
            /*052*/ new IFB_NUMERIC ( 16, "Personal identification number ( PIN) data",pad),
            ...
            /*057*/ new IFB_LLLCHAR ( 999, "Authorization life cycle code"),
            /*058*/ new IFB_LLLCHAR ( 999, "Authorizing agent institution Id Code"),
            ...
            /*068*/ new IFB_NUMERIC ( 4, "Country code, receiving institution",pad),
            /*069*/ new IFB_NUMERIC ( 4, "Country code, settlement institution",pad),
            /*070*/ new IFB_NUMERIC ( 4, "Country code, authorizing agent Inst.",pad),
            ...
            /*091*/ new IFB_NUMERIC ( 4, "Country code, transaction Dest. Inst.",pad),
            /*092*/ new IFB_NUMERIC ( 4, "Country code, transaction Orig. Inst.",pad),
            ...
            /*097*/ new IFB_NUMERIC ( 16,"Amount, Net reconciliation",pad),
