...
public class UfsCustomerComplaintsBatch implements Serializable {
    ...
    private Collection<UfsCustomerComplaints> ufsCustomerComplaintsCollection;
    ...
    public Collection<UfsCustomerComplaints> getUfsCustomerComplaintsCollection() {
        return ufsCustomerComplaintsCollection;
    }

    public void setUfsCustomerComplaintsCollection(Collection<UfsCustomerComplaints> ufsCustomerComplaintsCollection) {
        this.ufsCustomerComplaintsCollection = ufsCustomerComplaintsCollection;
    }
    ...
    public String toString() {
        return "com.mycompany.oracleufs.UfsCustomerComplaintsBatch[ batchId=" + batchId + " ]";
    }
