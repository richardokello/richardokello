...
@NamedQueries({
    @NamedQuery(name = "FailedTransactions.findAll", query = "SELECT f FROM FailedTransactions f")})
public class FailedTransactions implements Serializable {
   ...
   // private Date inserttime;
    ...
    public FailedTransactions(BigDecimal transactionnumber) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FailedTransactions)) {
            return false;
        }
        FailedTransactions other = (FailedTransactions) object;
    ...
    public String toString() {
        return "com.mycompany.oracleufs.FailedTransactions[ transactionnumber=" + transactionnumber + " ]";
    }
